...
#usual type of host in our dataset
host=[" localhost:8080"," localhost:9090"," localhost:8090"]
#store key value pair of HTTP payload 
dictionary = {}

#file to store data offline
filename = sys.argv[1]
f = open(filename.split(".")[0]+'FeatureExtracted.txt', 'w')
